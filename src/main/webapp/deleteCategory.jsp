...
<div class="container py-4">
    <div class="page-header">
        ...
        <p class="page-subtitle">Remove a category from the system</p>
    </div>
    ...
    <div class="content-card">
        ...
        <form action="deleteCategory" method="post">
            <div class="mb-3">
                ...
                <input type="text" name="categoryId" class="form-control" placeholder="Enter category ID to delete" required>
            </div>
